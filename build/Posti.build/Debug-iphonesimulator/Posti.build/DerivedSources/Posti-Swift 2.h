...
#ifndef POSTI_SWIFT_H
#define POSTI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Posti",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Posti11AppDelegate")
...
SWIFT_CLASS("_TtC5Posti18AuthViewController")
...
SWIFT_CLASS("_TtC5Posti14ImagesListCell")
@interface ImagesListCell : UITableViewCell
...
SWIFT_CLASS("_TtC5Posti24ImagesListViewController")
@interface ImagesListViewController : UIViewController
- (void)viewDidLoad;
...
@interface ImagesListViewController (SWIFT_EXTENSION(Posti)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface ImagesListViewController (SWIFT_EXTENSION(Posti)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC5Posti21ProfileViewController")
...
SWIFT_CLASS("_TtC5Posti13SceneDelegate")
...
SWIFT_CLASS("_TtC5Posti25SingleImageViewController")
@interface SingleImageViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)didTapBackButton;
- (IBAction)didTapShareButton:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SingleImageViewController (SWIFT_EXTENSION(Posti)) <UIScrollViewDelegate>
